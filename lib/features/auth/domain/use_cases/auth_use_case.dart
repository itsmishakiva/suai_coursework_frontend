...
class AuthUseCase implements IAuthUseCase {
  ...
  Future<String?> signup(String username, String password, String repeatPassword) async {
    if (username.length < 5) return 'Имя пользователя должно содержать не менее 5 символов';
    if (password.length < 5) return 'Пароль должен содержать не менее 5 символов';
